            ...
            <div class="modal-container">
                ...
                <ul class="notification-list">
                    ...
                    <li v-for="(notification, index) in notifications" :key="index" class="notification"
                        ...
                        <div v-if="notification?.type === 0" class="changeRead"
                            @click="putNotification(notification?.notifySeq, 0, notification?.typeSeq)">
                        ...
                        <div v-else-if="notification?.type === 1" class="changeRead"
                            @click="putNotification(notification?.notifySeq, 1, notification?.typeSeq)">
                        ...
                        <div v-else-if="notification?.type === 2" class="changeRead"
                            @click="putNotification(notification?.notifySeq, 2, notification?.typeSeq)">
                        ...
                        <div v-else-if="notification?.type === 4" class="changeRead"
                            @click="putNotification(notification?.notifySeq, 4, notification?.typeSeq)">
                        ...
                        <img src="@/assets/icon/trash.png" alt=""
                            @click="deleteNotification(notification?.notifySeq, index)" style="cursor:pointer">
                    </li>
                </ul>
            </div>
        </div>
